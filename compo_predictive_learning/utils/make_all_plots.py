...
from compo_predictive_learning.metrics.figure4 import plot_network_summary_2x2
...
def make_all_plots(config,
    ...
    try:
        fig,axs, _ = plot_network_summary_2x2(model,analysis_loader)
        savefig(figure_folders,f"figure4",fig)
    except Exception as e:
        print(f"Error in figure 4 summary plot: {e}")
